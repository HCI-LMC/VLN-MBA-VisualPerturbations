...
class GMapNavAgent(Seq2SeqAgent):
    ...
    def _panorama_feature_variable(self, obs):
        ...
        batch_view_img_fts,batch_view_depth_fts, batch_loc_fts, batch_nav_types = [], [], [], []
        ...
        return {
            'view_img_fts': batch_view_img_fts, 'view_depth_fts': batch_view_depth_fts,'loc_fts': batch_loc_fts,
    ...
    def _nav_vp_variable(self, obs, gmaps, pano_embeds, pano_depth_embeds,cand_vpids, view_lens, nav_types):
        batch_size = len(obs)
