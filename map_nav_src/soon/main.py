...
from agent_obj import SoonGMapObjectNavAgent

from data import ImageFeaturesDB,DepthFeaturesDB
from data_utils import ObjectFeatureDB, construct_instrs
from env import SoonObjectNavBatch
...
def build_dataset(args, rank=0, is_test=True):
    ...
    if args.aug is not None:
        ...
        aug_env = dataset_class(
            feat_db,dfeat_db, obj_db, aug_instr_data, args.connectivity_dir,
    ...
    train_env = dataset_class(
        feat_db, dfeat_db,obj_db, train_instr_data, args.connectivity_dir,
        batch_size=args.batch_size, max_objects=args.max_objects,
    ...
    for split in val_env_names:
        ...
        val_env = dataset_class(
            feat_db, dfeat_db,obj_db, val_instr_data, args.connectivity_dir, batch_size=args.batch_size*2,
            angle_feat_size=args.angle_feat_size, seed=args.seed+rank,
